...
class TestObservationStructure:
    ...
    def test_player_shape(self, env):
    ...
    def test_programs_shape(self, env):
    ...
    def test_player_values_normalized(self, env):
    ...
    def test_programs_binary(self, env):
...
class TestStepFunction:
    ...
    def test_step_observation_structure(self, env):
...
class TestValidActions:
    ...
    def test_get_valid_actions_returns_list(self, env):
    ...
    def test_valid_actions_in_range(self, env):
