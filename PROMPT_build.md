...
9999999999999999. COMPLETION: If all tasks in @IMPLEMENTATION_PLAN.md are complete and there is no more work remaining, output exactly this line as the final output: ${COMPLETION_PROMISE}